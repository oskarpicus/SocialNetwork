...
import socialnetwork.ui.ConsoleUIWithLogging;

public class MainCMDDataBaseWithLogging {
    public static void main(String[] args) {
        ...
        MasterServiceWithLogging masterService = new MasterServiceWithLogging(friendshipService,userService, friendRequestService,messageService);
        ConsoleUIWithLogging ui = new ConsoleUIWithLogging(masterService);
        ui.run();
    }
}
